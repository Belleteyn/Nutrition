...
static std::multimap<int16_t, FoodAvailable> giMap = {
  ...
  GIPair(60, FoodAvailable(Food("buckweed", 12.6, 62.1, 3.3, 313), 160, 10, FoodAvailable::Daily(160))),
  ...
  GIPair(0, FoodAvailable(Food("chicken", 23.6, 0.4, 1.9, 113), 200, 10, FoodAvailable::Daily(300, 200))),
